// تطبيق Express الأساسي (المسارات فقط) — بلا express.listen وبلا تقديم ملفات ثابتة
// يُستخدم من مصدرين: server/index.js (تشغيل محلي) و api/index.js (دالة Vercel serverless)
